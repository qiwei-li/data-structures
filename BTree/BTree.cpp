...
{
  BTreeNode* rootsplitptr = root->insert(value);
  if(rootsplitptr !=NULL)
  {
  InternalNode *topNode = new InternalNode(internalSize, leafSize, NULL, NULL, NULL);
  topNode->insert(root, rootsplitptr);
  root = topNode;
  }
} // BTree::insert()
